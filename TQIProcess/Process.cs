...
namespace TQIProcess
{
    public partial class Process
    {
        ...
        //public List<TQIClass> GetResult(string citFilePath, string iicFilePath, string idfFilePath, bool isReset)
        //{
        ...
        //    list = CalcTQI(citFilePath, listIC, header.iChannelNumber, sKmInc, true, sTQIItemIndex, f);

        //    return list;
        //}


        //public List<TQIClass> CalcTQI(string sWaveFileName, List<IndexStaClass> listIC, int gjtds, string sKmInc, bool bEncrypt, int[] sTQIItemIndex, float[] f)
        //{
        //    #region 计算TQI
        //    /*
        //     * 修正后的里程是连续的里程。
